...
def construct_plot(counts):
    ...
    for feeling_fields in counts:
        if feeling_fields:
            ...
            pwords_counts.append(feeling_fields[0][1])
            nwords_counts.append(feeling_fields[1][1])
...
def main():
    # load
    nfeeling_words = load_word_list("/home/qiuwennozomi/spark/Dataset/nFeeling.txt")
    pfeeling_words = load_word_list("/home/qiuwennozomi/spark/Dataset/pFeeling.txt")
